        ...
        public function init_form_fields() {
            $this->form_fields = array(
                ...
                'mandante_prefisso' => array(
                    ...
                    'type' => 'text',
                    'description' => __('Prefisso del MANDANTE'),
                    'default' => '(415)',
                    'desc_tip' => true,
                ),
                'mandante_codice_identificativo' => array(
                    'title' => __('Mandante, codice identificativo'),
                    'type' => 'text',
                    'description' => __('Codice identificativo del MANDANTE, 13 digit'),
                ...
                'cartalis_ftp_status' => array(
                    'title' => __('FTP Status'),
                    'type' => 'text',
                    'description' => __('Attiva (1), Disattiva (0), le funzionalità ftp'),
                    'default' => '0',
                    'desc_tip' => true,
                ),
                ...
                'cartalis_ftp_user' => array(
                    ...
                    'type' => 'text',
                    'description' => __('Username per la connessione ftp'),
                    'default' => '',
                    'desc_tip' => true,
                ),
                'cartalis_ftp_password' => array(
                    ...
                    'type' => 'text',
                    'description' => __('Password per la connessione ftp'),
                    'default' => '',
                    'desc_tip' => true,
                ),
                'cartalis_ftp_path' => array(
                    'title' => __('FTP Path'),
                    'type' => 'text',
                    'description' => __('Directory da cui recuperare il file'),
                    'default' => 'web/dev/',
                    'desc_tip' => true,
                ),
                'cartalis_tmp_directory' => array(
                    'title' => __('tmp directory'),
                    'type' => 'text',
                    'description' => __('Directory di appoggio per la lavorazione dei file'),
                    'default' => '/tmp',
                    'desc_tip' => true,
                ),
                'cartalis_email_alert' => array(
                'title' => __('Cartalis email alert'),
                'type' => 'text',
                'description' => __('Casella email cui inviare le notifiche di errore'),
                'default' => 'mionome@miaemail.com',
                'desc_tip' => true,
                ),
                'cartalis_status_new_order' => array(
                    'title' => __('Cartalis New Order Status'),
                    'type' => 'text',
                    'description' => __('Stato di lavorazione per il nuovo ordine'),
                    'default' => 'pending',
                    'desc_tip' => true,
                ),
                'cartalis_status_order_paid' => array(
                    'title' => __('Paid Order Status'),
                    'type' => 'text',
                    'description' => __('Stato di lavorazione per ordine pagato'),
                    'default' => 'on-hold',
                    'desc_tip' => true,
                ),
                'cartalis_log' => array(
                    'title' => __('Log File Path'),
                    'type' => 'text',
                    'description' => __('Path file di log'),
                    'default' => '/var/log',
                    'desc_tip' => true,
                )
            );
